...
class SettingsDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.create_text_types_tab()  # NEW: Text types filter tab
    ...
    def create_general_tab(self):
        ...
        self.ui_language_combo.setToolTip(self.config_manager.get_ui_text("ui_language_tooltip"))
        ...
        self.theme_combo.setToolTip(self.config_manager.get_ui_text("theme_tooltip"))
        layout.addRow(self.config_manager.get_ui_text("theme_label"), self.theme_combo)
        
        # Auto save settings
        self.auto_save_check = QCheckBox()
        self.auto_save_check.setToolTip(self.config_manager.get_ui_text("auto_save_tooltip"))
        ...
        self.auto_save_translations_check.setToolTip(self.config_manager.get_ui_text("auto_save_translations_tooltip"))
        ...
        self.check_updates_check.setToolTip(self.config_manager.get_ui_text("check_updates_tooltip"))
        ...
        self.unren_auto_download_check.setToolTip(self.config_manager.get_ui_text("unren_auto_download_tooltip"))
        unren_layout.addRow(
        ...
        self.unren_path_edit.setToolTip(self.config_manager.get_ui_text("unren_custom_path_tooltip"))
    ...
    def create_translation_tab(self):
        ...
        self.max_threads_spin.setToolTip(self.config_manager.get_ui_text("max_threads_tooltip"))
        perf_layout.addRow(self.config_manager.get_ui_text("max_threads_label"), self.max_threads_spin)
        
        self.max_batch_spin = QSpinBox()
        self.max_batch_spin.setRange(1, 2000)  # Increased max from 1000 to 2000
        self.max_batch_spin.setToolTip(self.config_manager.get_ui_text("max_batch_tooltip"))
        ...
        self.request_delay_spin.setToolTip(self.config_manager.get_ui_text("request_delay_tooltip"))
        perf_layout.addRow(self.config_manager.get_ui_text("request_delay_setting_label"), self.request_delay_spin)
        
        layout.addWidget(perf_group)
        
        # Multi-Endpoint Google settings (v2.1.0)
        multi_endpoint_group = QGroupBox(self.config_manager.get_ui_text("multi_endpoint_group"))
        multi_endpoint_layout = QFormLayout(multi_endpoint_group)
        
        self.use_multi_endpoint_check = QCheckBox()
        self.use_multi_endpoint_check.setToolTip(self.config_manager.get_ui_text("multi_endpoint_tooltip"))
        multi_endpoint_layout.addRow(self.config_manager.get_ui_text("use_multi_endpoint_label"), self.use_multi_endpoint_check)
        
        self.enable_lingva_fallback_check = QCheckBox()
        self.enable_lingva_fallback_check.setToolTip(self.config_manager.get_ui_text("lingva_fallback_tooltip"))
        multi_endpoint_layout.addRow(self.config_manager.get_ui_text("enable_lingva_fallback_label"), self.enable_lingva_fallback_check)
        
        self.endpoint_concurrency_spin = QSpinBox()
        self.endpoint_concurrency_spin.setRange(1, 32)
        self.endpoint_concurrency_spin.setToolTip(self.config_manager.get_ui_text("endpoint_concurrency_tooltip"))
        multi_endpoint_layout.addRow(self.config_manager.get_ui_text("endpoint_concurrency_label"), self.endpoint_concurrency_spin)
        
        self.max_chars_spin = QSpinBox()
        self.max_chars_spin.setRange(1000, 20000)
        self.max_chars_spin.setSingleStep(1000)
        self.max_chars_spin.setToolTip(self.config_manager.get_ui_text("max_chars_tooltip"))
        multi_endpoint_layout.addRow(self.config_manager.get_ui_text("max_chars_label"), self.max_chars_spin)
        
        layout.addWidget(multi_endpoint_group)
        ...
        self.max_retries_spin.setToolTip(self.config_manager.get_ui_text("max_retries_tooltip"))
        retry_layout.addRow(self.config_manager.get_ui_text("max_retries_label"), self.max_retries_spin)
        
        self.timeout_spin = QSpinBox()
        self.timeout_spin.setRange(5, 300)
        self.timeout_spin.setSuffix(" s")
        self.timeout_spin.setToolTip(self.config_manager.get_ui_text("timeout_tooltip"))
    ...
    def create_text_types_tab(self):
        """Create text types filter settings tab."""
        widget = QGroupBox()
        layout = QFormLayout(widget)
        
        # Description label
        desc_label = QLabel(self.config_manager.get_ui_text("text_types_description"))
        desc_label.setWordWrap(True)
        layout.addRow(desc_label)
        
        # Core text types group
        core_group = QGroupBox(self.config_manager.get_ui_text("core_text_types_group"))
        core_layout = QFormLayout(core_group)
        
        self.translate_dialogue_check = QCheckBox()
        self.translate_dialogue_check.setToolTip(self.config_manager.get_ui_text("translate_dialogue_tooltip"))
        core_layout.addRow(self.config_manager.get_ui_text("translate_dialogue_label"), self.translate_dialogue_check)
        
        self.translate_menu_check = QCheckBox()
        self.translate_menu_check.setToolTip(self.config_manager.get_ui_text("translate_menu_tooltip"))
        core_layout.addRow(self.config_manager.get_ui_text("translate_menu_label"), self.translate_menu_check)
        
        self.translate_buttons_check = QCheckBox()
        self.translate_buttons_check.setToolTip(self.config_manager.get_ui_text("translate_buttons_tooltip"))
        core_layout.addRow(self.config_manager.get_ui_text("translate_buttons_label"), self.translate_buttons_check)
        
        layout.addWidget(core_group)
        
        # UI/Screen text types group
        ui_group = QGroupBox(self.config_manager.get_ui_text("ui_text_types_group"))
        ui_layout = QFormLayout(ui_group)
        
        self.translate_ui_check = QCheckBox()
        self.translate_ui_check.setToolTip(self.config_manager.get_ui_text("translate_ui_tooltip"))
        ui_layout.addRow(self.config_manager.get_ui_text("translate_ui_label"), self.translate_ui_check)
        
        self.translate_input_check = QCheckBox()
        self.translate_input_check.setToolTip(self.config_manager.get_ui_text("translate_input_tooltip"))
        ui_layout.addRow(self.config_manager.get_ui_text("translate_input_label"), self.translate_input_check)
        
        self.translate_alt_text_check = QCheckBox()
        self.translate_alt_text_check.setToolTip(self.config_manager.get_ui_text("translate_alt_text_tooltip"))
        ui_layout.addRow(self.config_manager.get_ui_text("translate_alt_text_label"), self.translate_alt_text_check)
        
        layout.addWidget(ui_group)
        
        # Notifications and confirmations group
        notify_group = QGroupBox(self.config_manager.get_ui_text("notifications_group"))
        notify_layout = QFormLayout(notify_group)
        
        self.translate_notifications_check = QCheckBox()
        self.translate_notifications_check.setToolTip(self.config_manager.get_ui_text("translate_notifications_tooltip"))
        notify_layout.addRow(self.config_manager.get_ui_text("translate_notifications_label"), self.translate_notifications_check)
        
        self.translate_confirmations_check = QCheckBox()
        self.translate_confirmations_check.setToolTip(self.config_manager.get_ui_text("translate_confirmations_tooltip"))
        notify_layout.addRow(self.config_manager.get_ui_text("translate_confirmations_label"), self.translate_confirmations_check)
        
        layout.addWidget(notify_group)
        
        # Config/GUI strings group
        config_group = QGroupBox(self.config_manager.get_ui_text("config_text_types_group"))
        config_layout = QFormLayout(config_group)
        
        self.translate_config_check = QCheckBox()
        self.translate_config_check.setToolTip(self.config_manager.get_ui_text("translate_config_tooltip"))
        config_layout.addRow(self.config_manager.get_ui_text("translate_config_label"), self.translate_config_check)
        
        self.translate_gui_check = QCheckBox()
        self.translate_gui_check.setToolTip(self.config_manager.get_ui_text("translate_gui_tooltip"))
        config_layout.addRow(self.config_manager.get_ui_text("translate_gui_label"), self.translate_gui_check)
        
        self.translate_define_check = QCheckBox()
        self.translate_define_check.setToolTip(self.config_manager.get_ui_text("translate_define_tooltip"))
        config_layout.addRow(self.config_manager.get_ui_text("translate_define_label"), self.translate_define_check)
        
        self.translate_style_check = QCheckBox()
        self.translate_style_check.setToolTip(self.config_manager.get_ui_text("translate_style_tooltip"))
        config_layout.addRow(self.config_manager.get_ui_text("translate_style_label"), self.translate_style_check)
        
        self.translate_renpy_func_check = QCheckBox()
        self.translate_renpy_func_check.setToolTip(self.config_manager.get_ui_text("translate_renpy_func_tooltip"))
        config_layout.addRow(self.config_manager.get_ui_text("translate_renpy_func_label"), self.translate_renpy_func_check)
        
        layout.addWidget(config_group)
        
        self.tab_widget.addTab(widget, self.config_manager.get_ui_text("text_types_tab"))
    ...
    def create_proxy_tab(self):
        ...
        self.enable_proxy_check.setToolTip(self.config_manager.get_ui_text("enable_proxy_tooltip"))
        layout.addRow(self.config_manager.get_ui_text("enable_proxy_label"), self.enable_proxy_check)
        
        # Auto rotate
        self.auto_rotate_check = QCheckBox()
        self.auto_rotate_check.setToolTip(self.config_manager.get_ui_text("auto_rotate_tooltip"))
        layout.addRow(self.config_manager.get_ui_text("auto_rotate_label"), self.auto_rotate_check)
        
        # Test on startup
        self.test_startup_check = QCheckBox()
        self.test_startup_check.setToolTip(self.config_manager.get_ui_text("test_startup_tooltip"))
        ...
        self.update_interval_spin.setToolTip(self.config_manager.get_ui_text("update_interval_tooltip"))
        ...
        self.max_failures_spin.setToolTip(self.config_manager.get_ui_text("max_failures_tooltip"))
    ...
    def create_advanced_tab(self):
        ...
        self.log_level_combo.setToolTip(self.config_manager.get_ui_text("log_level_tooltip"))
        ...
        self.max_log_size_spin.setToolTip(self.config_manager.get_ui_text("max_log_size_tooltip"))
        ...
        self.chunk_size_spin.setToolTip(self.config_manager.get_ui_text("chunk_size_tooltip"))
        ...
        self.debug_mode_check.setToolTip(self.config_manager.get_ui_text("debug_mode_tooltip"))
        ...
        self.verbose_logging_check.setToolTip(self.config_manager.get_ui_text("verbose_logging_tooltip"))
    ...
    def load_settings(self):
        ...
        # Multi-endpoint Google settings (v2.1.0)
        self.use_multi_endpoint_check.setChecked(self.config_manager.translation_settings.use_multi_endpoint)
        self.enable_lingva_fallback_check.setChecked(self.config_manager.translation_settings.enable_lingva_fallback)
        self.endpoint_concurrency_spin.setValue(self.config_manager.translation_settings.endpoint_concurrency)
        self.max_chars_spin.setValue(self.config_manager.translation_settings.max_chars_per_request)
        ...
        self.translate_dialogue_check.setChecked(getattr(ts, 'translate_dialogue', True))
        self.translate_menu_check.setChecked(getattr(ts, 'translate_menu', True))
        self.translate_buttons_check.setChecked(getattr(ts, 'translate_buttons', True))
        self.translate_ui_check.setChecked(getattr(ts, 'translate_ui', True))
        self.translate_input_check.setChecked(getattr(ts, 'translate_input_text', True))
        self.translate_alt_text_check.setChecked(getattr(ts, 'translate_alt_text', True))
        self.translate_notifications_check.setChecked(getattr(ts, 'translate_notifications', True))
        self.translate_confirmations_check.setChecked(getattr(ts, 'translate_confirmations', True))
        self.translate_config_check.setChecked(getattr(ts, 'translate_config_strings', False))
        self.translate_gui_check.setChecked(getattr(ts, 'translate_gui_strings', False))
        self.translate_define_check.setChecked(getattr(ts, 'translate_define_strings', False))
        self.translate_style_check.setChecked(getattr(ts, 'translate_style_strings', False))
        self.translate_renpy_func_check.setChecked(getattr(ts, 'translate_renpy_functions', False))
    ...
    def save_settings(self):
        ...
        # Multi-endpoint Google settings (v2.1.0)
        self.config_manager.translation_settings.use_multi_endpoint = self.use_multi_endpoint_check.isChecked()
        self.config_manager.translation_settings.enable_lingva_fallback = self.enable_lingva_fallback_check.isChecked()
        self.config_manager.translation_settings.endpoint_concurrency = self.endpoint_concurrency_spin.value()
        self.config_manager.translation_settings.max_chars_per_request = self.max_chars_spin.value()
        ...
        # Text types settings
        ts = self.config_manager.translation_settings
        ts.translate_dialogue = self.translate_dialogue_check.isChecked()
        ts.translate_menu = self.translate_menu_check.isChecked()
        ts.translate_buttons = self.translate_buttons_check.isChecked()
        ts.translate_ui = self.translate_ui_check.isChecked()
        ts.translate_input_text = self.translate_input_check.isChecked()
        ts.translate_alt_text = self.translate_alt_text_check.isChecked()
        ts.translate_notifications = self.translate_notifications_check.isChecked()
        ts.translate_confirmations = self.translate_confirmations_check.isChecked()
        ts.translate_config_strings = self.translate_config_check.isChecked()
        ts.translate_gui_strings = self.translate_gui_check.isChecked()
        ts.translate_define_strings = self.translate_define_check.isChecked()
        ts.translate_style_strings = self.translate_style_check.isChecked()
        ts.translate_renpy_functions = self.translate_renpy_func_check.isChecked()
    ...
    def refresh_dialog_language(self):
        ...
        self.tab_widget.setTabText(2, self.config_manager.get_ui_text("text_types_tab"))
        self.tab_widget.setTabText(3, self.config_manager.get_ui_text("proxy_tab"))
        self.tab_widget.setTabText(4, self.config_manager.get_ui_text("advanced_tab"))
