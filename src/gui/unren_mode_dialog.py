...
class UnRenModeDialog(QDialog):
    ...
    def _select_mode(self, mode: str) -> None:
        ...
        try:
            ...
            # PySide6 fallback when accept() is not provided on the metaclass
            self.done(QDialog.DialogCode.Accepted if hasattr(QDialog, "DialogCode") else QDialog.Accepted)