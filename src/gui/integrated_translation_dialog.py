...
class IntegratedTranslationDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.engine_combo.addItem(self.config.get_ui_text("translation_engines.bing"), TranslationEngine.BING)
        self.engine_combo.addItem(self.config.get_ui_text("translation_engines.yandex"), TranslationEngine.YANDEX)
