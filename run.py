...
def main() -> int:
    ...
    try:
        ...
        # Load theme settings BEFORE creating the main window so components
        # initialize with the correct colors from the start.
        # ============================================================
        try:
            ...
            # Fallback will be handled by main window
